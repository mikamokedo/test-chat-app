...
import { updateInput,sendMessage,updateUserName, restoreMessage,IMessage } from './redux/slices/index'
...
// },[messages.length])
  ...
  return <>
    ...
    <div className=" flex flex-col gap-[10px] p-[20px]  max-h-[500px] overflow-y-scroll min-h-[500px]" ref={chatInner}>
      {currentMessages.map((mess) => <Message textContent={mess.text} name={mess.name === userName ? "you" : mess.name} isSender={mess.name === userName} key={mess.id}/>)}
